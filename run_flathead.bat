...
ocaml utility.cmo deque.cmo window.cmo screen.cmo immutable_bytes.cmo memory.cmo zstring.cmo instruction.cmo story.cmo dictionary.cmo reachability.cmo globals.cmo tokeniser.cmo iff.cmo quetzal.cmo evaluation_stack.cmo local_store.cmo frame.cmo frameset.cmo randomness.cmo transcript.cmo status_line.cmo interpreter.cmo graphics.cma button.cmo debugger.cmo flathead.ml
@del *.cmi
@del *.cmo
