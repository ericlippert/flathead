...
ocaml utility.cmo deque.cmo screen.cmo immutable_bytes.cmo memory.cmo story.cmo iff.cmo quetzal.cmo local_store.cmo frame.cmo interpreter.cmo graphics.cma button.cmo debugger.cmo flathead.ml
@del *.cmi
@del *.cmo
