...
ocaml type.cmo utility.cmo immutable_bytes.cmo story.cmo routine.cmo zstring.cmo dictionary.cmo object.cmo instruction.cmo reachability.cmo evaluation_stack.cmo local_store.cmo frame.cmo frameset.cmo flathead.ml
@del *.cmi
@del *.cmo
